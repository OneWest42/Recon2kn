...
nodef.write("  <key>order</key><integer>2</integer>\n")
...
pagef = open(ipaddr + "/NmapQuickScan/page.html", "w")
...
pagef.write("<title>Nmap: Quick Scan</title>\n")
pagef.write("</head><body><tt><span style=\"font-family: Sans\"><b>nmap --top-ports 50 ")
pagef.write(ipaddr)
pagef.write("</b><br/>\n")
pagef.write("</span></tt><span style=\"font-family: Sans\">\n")

#Run nmap, print out and write to page.html
print "--------------Nmap(Quick Scan) started for %s------------\n" % (ipaddr)
quicknmap = "nmap --top-ports 50 " + ipaddr + " --open"
#print quicknmap
output = subprocess.check_output(quicknmap, shell=True)
lines = output.split("\n")
for line in lines:
 	print line
	line = line.replace(" ", " &nbsp;")
...
print "--------------Nmap(Quick Scan) finished for %s-----------\n" % (ipaddr)
